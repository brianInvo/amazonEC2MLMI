...
Why are we computing this when amazon provides a calculator? This lets us begin to build a predictive estimate for future work and modify/adjust over time.  Furthermore, it's faster and more scriptable, versus endless poking around a website GUI, to have such a tool.
...
We assign the following values for eq-$\ref{eq:1}$:
...
amzn = read.csv( "/Users/stnava/code/amazonEC2cost/calcAmznBrainAge.csv" )
...
Only implementation will reveal true costs.
